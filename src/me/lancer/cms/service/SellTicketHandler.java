...
public class SellTicketHandler {
	...
	public String getInfo() {
		...
		for (Ticket t : ticketList) {
			info += "Play£º" + t.getPlayName() + "\n";
			info += "Session£º" + DateFormat.getDateTimeInstance().format(t.getSchedule().getTime()) + "\n";
			info += "Seat£º" + t.getSeat().getRow() + "Row" + t.getSeat().getColumn() + "\n";
