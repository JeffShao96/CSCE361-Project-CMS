...
public class SaleUI extends JPanel {
	...
	public void showTable() {
		...
		Object[] in = { "ID", "Employee", "Time", "Payment", "Change", "Type", "Condition" };
	...
	public static void showPanel() {
		JFrame frame = new JFrame("Sale Manage");
	...
	class SaleDialog extends JDialog {
		...
		SaleDialog(final int flag) {
			...
			lblTime.setFont(new Font("Times New Romen", Font.PLAIN, 16));
			...
			lblType.setFont(new Font("Times New Romen", Font.PLAIN, 16));
			...
			btnYes.setFont(new Font("Times New Roman", Font.PLAIN, 16));
