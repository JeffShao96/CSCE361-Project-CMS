...
public class MainUI extends JPanel {
	...
	public MainUI() {
		...
		if (getRst() != -1) {
			...
			JOptionPane.showMessageDialog(null, "Error of user name or password!");
			System.exit(0);
		} else if (getRst() == -2) {
			JOptionPane.showMessageDialog(null, "User name and password could not be empty!");
			System.exit(0);
		}
	}
	...
	class LoginDialog extends JDialog {
		...
		LoginDialog() {
			this.setTitle("Welcome to use Cinema Management System!");
			...
			lblUsrName.setFont(new Font("Times New Romen", Font.PLAIN, 16));
