...
class DataDictTable {
	...
	public void createTable(JTable dictTable, JScrollPane scrollPane, Object[] columnNames, List<DataDict> dictList) {
		try {
			...
			dictTable.getTableHeader().setFont(new Font("Times New Romen", Font.PLAIN, 16));
			dictTable.setFont(new Font("Times New Romen", Font.PLAIN, 14));
...
public class DataDictUI extends JPanel {
	...
	protected void initContent() {
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				DataDictDialog ddictDialog = new DataDictDialog(1);
				ddictDialog.toFront();
		...
		btnQuery.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				DataDictDialog ddictDialog = new DataDictDialog(2);
				ddictDialog.toFront();
				ddictDialog.setModal(true);
				ddictDialog.setVisible(true);
				showTable();
		...
		btnEdit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				DataDictDialog ddictDialog = new DataDictDialog(3);
				ddictDialog.toFront();
				ddictDialog.setModal(true);
				ddictDialog.setVisible(true);
				showTable();
		...
		btnDel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				DataDictDialog ddictDialog = new DataDictDialog(4);
				ddictDialog.toFront();
				ddictDialog.setModal(true);
				ddictDialog.setVisible(true);
				showTable();
	...
	private JTree createTree() {
		DefaultMutableTreeNode root = new DefaultMutableTreeNode("Data Dictionary");
	...
	public static void showPanel() {
		JFrame frame = new JFrame("Data dictionary Manage");
	...
	class DataDictDialog extends JDialog {
		...
		DataDictDialog(final int flag) {
			...
			this.setTitle("Data Dictionary Operation");
		...
		private void btnAddClicked() {
			if (txtParent.getText().length() > 0 && txtName.getText().length() > 0 && txtValue.getText().length() > 0) {
				...
				JOptionPane.showMessageDialog(null, "Imcomplete data!","Message",JOptionPane.PLAIN_MESSAGE);
			}
		}
