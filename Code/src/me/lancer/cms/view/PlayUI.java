...
public class PlayUI extends JPanel {
	...
	public void showTable() {
		...
		Object[] in = { "ID", "Type", "Language", "Name", "Description", "Time", "Price", "Condition" };
	...
	public static void showPanel() {
		JFrame frame = new JFrame("Movie Manage");
	...
	class PlayDialog extends JDialog {
		...
		PlayDialog(final int flag) {
			...
			lblLength.setFont(new Font("Times New Romen", Font.PLAIN, 16));
